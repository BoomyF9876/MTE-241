...
*               to main.c or bst.c.
*****************************************************************
*  1. Deleted white space in front of and behind the function inputs.
*  2. Combined every else or else if conditions and the close bracket of the if statement into one line, adjusted comments accordingly.
*  3. Added space before every keywords such as if, while, else if etc.
*  4. Added space before the start of the brackets and after the conditions
*  5. Adjusted the identation from 4 to 2 spaces.
****************************************************************/
